...
export class ElevenLabsSpeakTool extends Tool {
    ...
    constructor() {
        super(
            ...
            `
                ...
                Opcionalmente, forneça a voz que será utilizada. Se não for fornecida, a voz será obtida a partir da variável de ambiente 'ELEVEN_LABS_VOICE'.
        ...
        this.addField({
            name: "voice",
            type: "string",
            description: "Opcionalmente, a voz que será utilizada para a síntese de fala. Se não for fornecida, a voz será obtida a partir da variável de ambiente 'ELEVEN_LABS_VOICE' ou será usado um valor padrão.",
        });
    }
    ...
    async run(arg: string): Promise<string> {
        ...
        const selectedVoice = voice || process.env.ELEVEN_LABS_VOICE || "Alcione";
